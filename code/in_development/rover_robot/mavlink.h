...
*
*---------------------------------------------------------------------------
*Code Reuse: https://github.com/mavlink/c_library_v1/tree/master/common (MACROS for constructing Heartbeat and SCALED_IMU packets)
*Note      : Mavlink v1 followed for simplicity.Mavlink v2 packet structure fields are complicated and
