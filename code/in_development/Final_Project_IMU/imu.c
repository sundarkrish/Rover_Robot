...
bool IMU_init(void)
{
    ...
    error_status = I2C1_Write(FXOS8700_ADDRESS, FXOS8700CQ_CTRL_REG1, 0x1D);
    ...
    error_status = I2C1_Write(FXAS21002C_ADDRESS, FXAS21002C_REGISTER_CTRL_REG1, 0x12); // Active and ODR : 50Hz
